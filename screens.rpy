...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(80, 260, 440, 100) action Start()
        hotspot(50, 430, 520, 90) action ShowMenu("load")
        hotspot(50, 580, 540, 80) action ShowMenu("preferences")
        hotspot(1650, 980, 260, 80) action Quit(confirm=True)
